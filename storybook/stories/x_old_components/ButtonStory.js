...
storiesOf('old_components/Button', module)
...
function Kinds() {
  ...
  return (
    <Root>
      ...
      <p>
        {kinds.map(kind => (
          <Button kind={kind} key={kind} onClick={onClick} href={href} outlineOnly>
            {kind}
          </Button>
        ))}
      </p>
      ...
      <p>
        {kinds.map(kind => (
          <Button kind={kind} key={kind} onClick={onClick} href={href} outlineOnly disabled>
            {kind}
          </Button>
        ))}
      </p>
