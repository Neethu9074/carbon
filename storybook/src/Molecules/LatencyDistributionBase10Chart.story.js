...
const mockSubscription = {
  data: [
    { to: 1, calls: 51880, tickMark: true, percentiles: [50] },
    ...
    { from: 6, to: 7, calls: 5240, tickMark: false, percentiles: [90] },
    { from: 7, to: 8, calls: 5197, tickMark: false },
    { from: 8, to: 10, calls: 4810, tickMark: false },
    { from: 10, to: 11, calls: 6737, tickMark: true, percentiles: [95] },
    ...
    { from: 116, to: 135, calls: 180, tickMark: false, percentiles: [99] },
...
const mockSubscription2 = {
  data: [
    { to: 1, calls: 51880, tickMark: true, percentiles: [50, 90] },
    { from: 1, to: 2, calls: 119719, tickMark: false },
    { from: 2, to: 3, calls: 26471, tickMark: false },
    { from: 3, to: 4, calls: 13724, tickMark: false },
    { from: 4, to: 5, calls: 13035, tickMark: false },
...
const mockSubscription3 = {
  data: [
    ...
    { from: 1, to: 2, calls: 119719, tickMark: false, percentiles: [50, 90, 95] },
    { from: 2, to: 3, calls: 26471, tickMark: false },
    { from: 3, to: 4, calls: 13724, tickMark: false },
    { from: 4, to: 5, calls: 13035, tickMark: false },
    { from: 5, to: 6, calls: 7261, tickMark: false },
