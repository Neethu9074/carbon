...
import fragmentShader from 'in-new-components/ApplicationMap/misc/ParticleEmitter/shader/fragmentShader.glsl';
import vertexShader from 'in-new-components/ApplicationMap/misc/ParticleEmitter/shader/vertexShader.glsl';
