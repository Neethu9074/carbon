import HoveredConncetionsServiceLocator from 'in-new-components/ApplicationMap/serviceLocator/HoveredConncetionsServiceLocator/HoveredConncetionsServiceLocator';
import HiddenEntitiesServiceLocator from 'in-new-components/ApplicationMap/serviceLocator/HiddenEntitiesServiceLocator/HiddenEntitiesServiceLocator';
import ConnectionsServiceLocator from 'in-new-components/ApplicationMap/serviceLocator/ConnectionsServiceLocator/ConnectionsServiceLocator';
import EventBusServiceLocator from 'in-new-components/ApplicationMap/serviceLocator/EventBusServiceLocator/EventBusServiceLocator';
import SceneServiceLocator from 'in-new-components/ApplicationMap/serviceLocator/SceneServiceLocator/SceneServiceLocator';
import NodesServiceLocator from 'in-new-components/ApplicationMap/serviceLocator/NodesServiceLocator/NodesServiceLocator';
