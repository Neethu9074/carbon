...
import CameraController from 'in-new-components/ApplicationMap/misc/CameraController';
import Camera from 'in-new-components/ApplicationMap/sceneObjects/OrthographicCamera';
import Renderer from 'in-new-components/ApplicationMap/sceneObjects/Renderer';
import TimeTracker from 'in-new-components/ApplicationMap/misc/TimeTracker';
