...
export default function Summary({ timeConfig, data: host }: SummaryData) {
  ...
  return (
    <>
      ...
      <KpiGridRow sizes={[3, 3, 3, 3]}>
        <KpiCard title={t('in-linux-kvm-hypervisor:dashboards.cpuCores')} value={host.numberOfCpuCores || 'N/A'} />
        <KpiCard title={t('in-linux-kvm-hypervisor:dashboards.cpuFrequency')} value={host.cpuFrequencyMhz || 'N/A'} />
        <InfraMetricKpiCard
        ...
        />
        <KpiCard
          title={t('in-linux-kvm-hypervisor:dashboards.hypervisorVersion')}
          value={host.hypervisorVersion || 'N/A'}
        />
      </KpiGridRow>
