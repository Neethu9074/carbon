...
export const nonServicePlugins = {
  ...
  powervcInstance: 'powervcInstance',
  process: 'process',
...
export const fullyQualifiedPlugins = {
  ...
  powervcRegion: 'com.instana.forge.infrastructure.paas.ibmpowervc.derivedentity.region',
  powervcHypervisor: 'com.instana.forge.infrastructure.paas.ibmpowervc.derivedentity.hypervisor',
  powervcInstance: 'com.instana.forge.infrastructure.paas.ibmopenstack.derivedentity.computeinstance',
