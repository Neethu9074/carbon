...
export default function AwsApiGatewayRestDashboard({ snapshot, timeConfig }) {
  ...
  return (
    <div>
      ...
      <Columize>
        <DashboardSection title={t('in-forge:plugins.awsApiGateway.titleCacheHitCount')}>
          <Chart
            snapshotId={snapshotId}
            timeConfig={timeConfig}
            y1={{
        ...
        <DashboardSection title={t('in-forge:plugins.awsApiGateway.titleCacheMissCount')}>
          <Chart
            snapshotId={snapshotId}
            timeConfig={timeConfig}
            y1={{
