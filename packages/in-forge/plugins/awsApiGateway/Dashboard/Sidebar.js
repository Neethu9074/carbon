...
import Info from 'in-forge/plugins/awsApiGateway/Info';
import { t } from 'in-i18n';

export default function AwsApigatewaySidebar({ snapshot }) {
  return (
    <div>
      <Collapsible initiallyOpen>
        <Collapsible.Header>{t('in-forge:plugins.awsApiGateway.headerApiGatewayInfo')}</Collapsible.Header>
        <Collapsible.Content>
