...
import getChildOtelProcesses from 'in-subscription/getChildOtelProcesses';
...
export default connectTo(
  props => ({
    processes: timeConfig$
      .flatMap(timeConfig => getChildOtelProcesses({ snapshotId: props.snapshotId, timeConfig }))
