...
import { bytesZeroDecimalPlaces, percentage, percentageTwoDecimalPlaces } from 'in-services/formatters/number';
...
const cols = [
  ...
  {
    title: t('in-forge:plugins.ibmCloudEtcd.titleLimit'),
    type: 'metric',
    typeArgs: {
      getSnapshotId(row) {
  ...
  return (
    <Chart
      ...
      y1={{
        ...
        labels: [t('in-forge:plugins.ibmCloudEtcd.titleUsedPercent')],
        type: 'line'
      }}
