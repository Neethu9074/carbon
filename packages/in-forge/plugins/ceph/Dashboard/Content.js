  ...
  if (sensorStatusCode !== 1) {
    return (
      <DashboardNotification type="info">
        Agent could not connect to the Ceph cluster, Ceph executable not found. Set &apos;ceph-executable-path&apos;
        property to the path of Ceph executable in the agent configuration.
        ...
        <DashboardSection title={t('in-forge:plugins.ceph.dashboard.titleLatency')}>
          <Chart
            ...
            y1={{
              ...
              labels: [
                t('in-forge:plugins.ceph.dashboard.labelCommit'),
                t('in-forge:plugins.ceph.dashboard.labelApply')
              ],
              type: 'line',
