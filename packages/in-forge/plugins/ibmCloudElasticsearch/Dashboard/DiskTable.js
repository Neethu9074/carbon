...
const cols = [
  ...
  {
    title: t('in-forge:plugins.ibmCloudElasticsearch.used'),
    type: 'metric',
    typeArgs: {
      getSnapshotId(row) {
  ...
  {
    title: t('in-forge:plugins.ibmCloudElasticsearch.total'),
    type: 'metric',
    typeArgs: {
      getSnapshotId(row) {
        return row.snapshotId;
  ...
  {
    title: t('in-forge:plugins.ibmCloudElasticsearch.usedPercent'),
    type: 'sparkChart',
    typeArgs: {
      getSnapshotId(row) {
        return row.snapshotId;
...
export default connectTo(
  ...
  function DiskTable({ snapshot, timeConfig, memberIds }) {
    ...
    return (
      <Table
        withoutPadding
        cardTitle={t('in-forge:plugins.ibmCloudElasticsearch.titleDisk')}
        cols={cols}
        rows={rows}
  ...
  return (
    <Chart
      ...
      y1={{
        ...
        labels: [t('in-forge:plugins.ibmCloudElasticsearch.used')],
        type: 'line'
      }}
      y2={{
        min: 0,
        ...
        labels: [t('in-forge:plugins.ibmCloudElasticsearch.usedPercent')],
        type: 'line'
      }}
