...
const cols = [
  ...
  {
    title: t('in-forge:plugins.ibmCloudRabbitMq.diskIOPercent'),
    type: 'metric',
    typeArgs: {
      getSnapshotId(row) {
  ...
  {
    title: t('in-forge:plugins.ibmCloudRabbitMq.iOPSTotal'),
    type: 'metric',
    typeArgs: {
      getSnapshotId(row) {
        return row.snapshotId;
  ...
  return (
    <Chart
      ...
      y1={{
        ...
        labels: [t('in-forge:plugins.ibmCloudRabbitMq.diskIOPercent')],
        type: 'line'
      }}
      y2={{
        min: 0,
        ...
        labels: [t('in-forge:plugins.ibmCloudRabbitMq.iOPSTotal')],
        type: 'line'
      }}
