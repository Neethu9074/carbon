...
const cols = [
  ...
  {
    title: t('in-forge:plugins.ibmCloudRedis.titleLimit'),
    type: 'metric',
    typeArgs: {
      getSnapshotId(row) {
        return row.snapshotId;
  ...
  {
    title: t('in-forge:plugins.ibmCloudRedis.titleUsedPercent'),
    //type: 'metric',
    type: 'sparkChart',
    typeArgs: {
      getSnapshotId(row) {
...
export default connectTo(
  ...
  function MemoryTable({ snapshot, timeConfig, member_ids }) {
    ...
    return (
      <Table
        withoutPadding
        cardTitle={t('in-forge:plugins.ibmCloudRedis.titleMemory')}
        cols={cols}
        rows={rows}
      ...
      <DashboardSection>
        <Chart
          ...
          y1={{
            ...
            labels: [t('in-forge:plugins.ibmCloudRedis.labelUsedBytes')],
            type: 'line'
          }}
      ...
      <DashboardSection>
        <Chart
          ...
          y1={{
            ...
            labels: [t('in-forge:plugins.ibmCloudRedis.memoryUtilization')],
            type: 'line'
          }}
          renderPostChartContent={PluginDashboardsMarkerLanes}
        />
