...
export default function AzureMachineLearningSidebarDetails({ snapshot }: { snapshot: SnapshotData }) {
  return (
    <>
      <Collapsible initiallyOpen>
        <Collapsible.Header>{t('in-forge:plugins.azureMachineLearning.infoAzureMachineLearning')}</Collapsible.Header>
        <Collapsible.Content>
