...
import MemoryTable from 'in-forge/plugins/ibmCloudHPMongoDb/Dashboard/MemoryTable';
import DiskTable from 'in-forge/plugins/ibmCloudHPMongoDb/Dashboard/DiskTable';
import CpuTable from 'in-forge/plugins/ibmCloudHPMongoDb/Dashboard/CpuTable';
...
export default connectTo(
  ...
  function IbmHPMongoDbDashboard({ snapshot, timeConfig, nodeIds, mounts }) {
    return (
      <div>
