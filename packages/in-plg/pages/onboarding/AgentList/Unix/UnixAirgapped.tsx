...
const UnixAirGappedArchives = ({ agentKey, downloadKey, instanaDomain, fromOnboarding }: OnboardingProps) => {
  const sideCardData = [
    {
  ...
  return (
    <Container>
      <MainBody>
        ...
        <LayoutSection title={t('in-plg:agentDetails.unix.unix_airgapped.step1DownloadTheInstallArchive')}>
          <KeyValue
            label={t('in-plg:agentDetails.unix.unix_airgapped.airgappedArchives')}
            value={
              <InputWithButton
                type="copy"
                size="large"
        ...
        <GetDeployedAgents agent="unix" fromOnboarding={fromOnboarding} />
      </MainBody>
      <SidePanel>
...
export default UnixAirGappedArchives;
