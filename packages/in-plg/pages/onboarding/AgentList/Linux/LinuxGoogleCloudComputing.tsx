...
export default function LinuxGoogleCloudComputing({
  agentKey,
  downloadKey,
  agentEndpoint,
  agentEndpointPort,
  ...
  const sideCardData = [
    ...
    },
    {
      ...
      body: (
        <Stack>
          <DocumentLink
            text={t('in-plg:agentDetails.linux.linux_gce.installAnAgentOnLinux')}
            href="https://ibm.biz/insta-agent-linuxgce"
          />
          <DocumentLink
            text={t('in-plg:agentDetails.linux.linux_gce.configurationParameters')}
