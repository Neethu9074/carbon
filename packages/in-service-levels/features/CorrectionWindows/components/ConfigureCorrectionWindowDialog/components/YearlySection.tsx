...
import MonthSection from 'in-service-levels/features/CorrectionWindows/components/ConfigureCorrectionWindowDialog/components/MonthSection';
        ...
        <>
          <Column lg={4} md={4}>
            <Dropdown
              ...
              id="correction-window-yearly-interval"
          ...
          <Column className={locals['margin-top']} lg={1}>
            <span>of</span>
          </Column>
          <MonthSection />
        </>
