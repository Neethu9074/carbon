...
export interface PoliciesButtonGroupProps {
  selectedType: string;
  setSelectedType: (str: string) => void;
}

export default function PoliciesButtonGroup({ selectedType, setSelectedType }: PoliciesButtonGroupProps) {
  const buttonProps = [
    {
      text: t('in-automation:associatedPolicies'),
      key: 'associatedPolicies',
      onClick: () => setSelectedType('associatedPolicies')
    },
    {
