...
function AutomationCardForLegacyPRC({ volatileId, event, incident }: AutomationCardProps) {
      ...
      <Col xs>
        <Card>
          ...
          {activeKey === 'recommendedActions' && (
            <RecommendedActionsForLegacyPRC
              event={event}
              volatileId={volatileId}
              trigger={trigger}
...
function AutomationCardWithOptimization({ volatileId, event, incident }: AutomationCardProps) {
  return (
    <>
      <AutomationCardForLegacyPRC volatileId={volatileId} event={event} incident={incident} />
    </>
  );
}
