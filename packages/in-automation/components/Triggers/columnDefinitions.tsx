...
function WebsiteFilterAppliedColumn({ item }: { item: WebsiteAlertConfigWithMetadata }) {
...
function MobileAppFilterAppliedColumn({ item }: { item: MobileAppAlertConfigWithMetadata }) {
