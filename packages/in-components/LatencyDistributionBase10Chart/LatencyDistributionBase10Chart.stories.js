...
export const dashboard = ({ height, width }) => (
...
dashboard.args = { height: 182, width: 552 };

export const dashboardWithTimeShift = ({ height, width }) => (
  <LatencyDistributionBase10Chart
    subscription={just(mockSubscription)}
...
dashboardWithTimeShift.args = { height: 182, width: 552 };

export const unboundedAnalytics = ({ height }) => (
  <LatencyDistributionBase10Chart
    subscription={just(mockSubscription)}
    chartDefinition={chartDefinition}
    cheight={height}
...
unboundedAnalytics.args = { height: 172 };

export const stackedUp2Percentiles = ({ height, width }) => (
  <LatencyDistributionBase10Chart
...
stackedUp2Percentiles.args = { height: 130, width: 872 };

export const stackedUp3Percentiles = ({ height, width }) => (
  <LatencyDistributionBase10Chart
...
stackedUp3Percentiles.args = { height: 130, width: 872 };
...
loading.args = { height: 130, width: 1300 };

export const noDataAvailable = ({ height, width }) => (
  <LatencyDistributionBase10Chart
...
noDataAvailable.args = { height: 130, width: 1300 };

export const noDataToDisplay = ({ height, width }) => (
  <LatencyDistributionBase10Chart
...
noDataToDisplay.args = { height: 130, width: 1300 };
