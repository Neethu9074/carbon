...
function getHighlightedTimeframeUrl$(chart) {
  return combineLatest([chart.config.localHighlightedTimeframe$, timeConfig$]).flatMap(
    ([highlightedTimeframe, originalTimeConfig]) => {
