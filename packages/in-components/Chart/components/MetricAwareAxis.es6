...
import { MARGIN_BOTTOM } from 'in-components/Chart/Scales';
...
export default connectTo(
  ...
  function MetricAwareAxis({ scale, axis, height, align }) {
    return <VerticalAxis formatter={axis.formatter[0]} scale={scale} align={align} height={height - MARGIN_BOTTOM} />;
  }
);
