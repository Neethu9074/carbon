...
>(props: PropsType) {
  ...
  const getWidthInAbsoluteUnit = (ellipsis: string | boolean | undefined, widthInAbsoluteUnit: boolean | undefined) => {
    if (typeof ellipsis === 'string') {
  ...
  body = (
    <CarbonDataTable
      ...
      onRowMouseEnter={onRowMouseEnter ?? undefined}
  ...
  return (
    ...
    >
      ...
      <>
        ...
        {!cardTitle && header && (
          <div className={classNames(locals.carbonHeader, headerClassName)}>
