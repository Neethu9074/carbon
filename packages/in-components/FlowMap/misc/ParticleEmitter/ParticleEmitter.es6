...
import fragmentShader from 'in-components/FlowMap/misc/ParticleEmitter/shader/fragmentShader.glsl';
import vertexShader from 'in-components/FlowMap/misc/ParticleEmitter/shader/vertexShader.glsl';
...
export default class ParticleEmitter {
  ...
  start() {
    ...
    // TODO: bind to metric
    this.setNumparticlesPerSecond(Math.ceil(Math.random() * 10), Math.random() * 0.25);
  }
