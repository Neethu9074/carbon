  ...
  if (clusterVersion) {
    ...
    return (
      <>
        ...
        {getEtcdChart(clusterVersion, snapshotId, timeConfig)}
      </>
    );
  }
...
function getEtcdChart(clusterVersion: string, snapshotId: string, timeConfig: TimeConfig) {
  if (parseClusterVersion(clusterVersion) >= 3) {
