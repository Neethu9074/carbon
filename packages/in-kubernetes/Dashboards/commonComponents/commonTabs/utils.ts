...
interface GetOtelKubernetesContainersQuery extends KubernetesQueryFilter, KubernetesQuery {}

export function getOtelKubernetesContainersData({
  query = '',
  page = 1,
  pageSize = 20,
  orderBy = 'health',
  ...
  podId,
  workloadControllerId
}: GetOtelKubernetesContainersQuery) {
