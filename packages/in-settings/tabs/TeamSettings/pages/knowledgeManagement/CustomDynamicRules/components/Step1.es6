...
import MatchingEntityTable from 'in-settings/tabs/TeamSettings/pages/knowledgeManagement/CustomDynamicRules/components/MatchingEntityTable';
import TooltipIcon from 'in-settings/tabs/TeamSettings/pages/knowledgeManagement/CustomDynamicRules/components/TooltipIcon';
import MetricSelector from 'in-settings/tabs/TeamSettings/pages/knowledgeManagement/CustomRules/components/MetricSelector';
import Spacer from 'in-settings/tabs/TeamSettings/pages/knowledgeManagement/CustomDynamicRules/components/Spacer';
