...
import createSensitivityDefaultChartController from 'in-settings/tabs/TeamSettings/pages/knowledgeManagement/CustomDynamicRules/components/sensitivityDefaultChartController';
