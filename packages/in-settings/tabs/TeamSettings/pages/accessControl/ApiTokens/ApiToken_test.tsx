...
import ApiToken from 'in-settings/tabs/TeamSettings/pages/accessControl/ApiTokens/ApiToken';
...
describe('in-settings/tabs/TeamSettings/pages/Users/Users', () => {
  ...
  it('should close the dialog when click on outside of the dialog and go back to Api Token List page', async () => {
    ...
    expect(mockGoToPath).toHaveBeenCalledWith(teamSettingsAccessControlApiTokens);
  });
  ...
  it('should call saveApiToken api (Create Mode) after clicking on Submit button and go back to Api Token List page', async () => {
    ...
    expect(close).toHaveBeenCalled();
    expect(mockGoToPath(teamSettingsAccessControlApiTokens));
  });
