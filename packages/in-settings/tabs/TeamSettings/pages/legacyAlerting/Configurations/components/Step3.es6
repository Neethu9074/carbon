...
import AddNewIntegrationDialog from 'in-settings/tabs/TeamSettings/pages/legacyAlerting/Configurations/components/AddNewIntegrationDialog';
import IntegrationsDetails from 'in-settings/tabs/TeamSettings/pages/legacyAlerting/Integrations/components/IntegrationsDetails';
