...
import DbIntegrationsBreadcumb from 'in-settings/tabs/TeamSettings/pages/integrations/database/Integrations/DbIntegrationsBreadcrumb';
import { callToastFlyout } from 'in-settings/tabs/TeamSettings/pages/integrations/database/Integrations/utils';
import DbMarlinForm from 'in-settings/tabs/TeamSettings/pages/integrations/database/DbMarlin/DbMarlinForm';
...
export default function DbMarlin() {
  ...
  const { form, loading, message, onChange, onSubmit } = useIntegrationForm({
    ...
    onSaveSuccess: () => {
      ...
      goToPath(teamSettingsIntegrationsDatabaseDbMarlin);
    },
    onSaveError: () => {
...
function createForm(integration?: Integration): IntegrationForm {
  return createMapForm<IntegrationFormFields>({
    items: {
      ...
      path: createField<string>({ value: teamSettingsIntegrationsDatabaseDbMarlin }),
