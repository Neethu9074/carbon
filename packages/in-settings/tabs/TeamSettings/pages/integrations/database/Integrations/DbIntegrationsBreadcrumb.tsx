...
import { teamSettingsIntegrationsDatabase } from 'in-settings/navigation/paths';
...
export default function DbIntegrationsBreadcrumb() {
  ...
  return (
    <Breadcrumb className={locals.breadcrumb} onClick={() => goToPath(teamSettingsIntegrationsDatabase)}>
