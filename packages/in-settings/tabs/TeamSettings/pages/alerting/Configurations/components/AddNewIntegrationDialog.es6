...
import IntegrationSwitch from 'in-settings/tabs/TeamSettings/pages/alerting/Integrations/components/IntegrationSwitch';
import configs from 'in-settings/tabs/TeamSettings/pages/alerting/Integrations/configs';
