...
import AddNewIntegrationDialog from 'in-settings/tabs/TeamSettings/pages/alerting/Configurations/components/AddNewIntegrationDialog';
import IntegrationsDetails from 'in-settings/tabs/TeamSettings/pages/alerting/Integrations/components/IntegrationsDetails';
