...
import ServiceExtractionEndpointRuleConfigSubForm from 'in-settings/tabs/TeamSettings/pages/legacyServiceExtraction/ServiceExtractionRuleConfig/ServiceExtractionEndpointRuleConfigSubForm';
import { getServiceRule, saveServiceRule, createServiceRule, createEndpointRule } from 'in-api/serviceExtraction';
import ServiceExtractionRuleConfigForm from 'in-settings/tabs/TeamSettings/pages/legacyServiceExtraction/ServiceExtractionRuleConfig/ServiceExtractionRuleConfigForm';
import { typeDefinitions } from 'in-settings/tabs/TeamSettings/pages/legacyServiceExtraction/ServiceExtractionRuleConfig/types';
