...
} from 'in-settings/components/tableColumnPresets';
import {
  upsertServiceRules,
...
import { getServiceExtractionRuleConfigPath, getEntityIdView } from 'in-settings/navigation/paths';
import { openEditor } from 'in-settings/tabs/TeamSettings/pages/legacyServiceExtraction/ServiceExtraction/stores/editAsJson';
...
export default class extends React.Component {
  constructor(props) {
    ...
    const linkColumn = getLinkColumn(
      (key, params) => getEntityIdView(getServiceExtractionRuleConfigPath(key, params)),
      'name',
      props.link
    );
