...
import SensitivityDefaultChart from 'in-settings/tabs/TeamSettings/pages/legacyKnowledgeManagement/CustomDynamicRules/components/SensitivityDefaultChart';
