...
} from 'in-settings/tabs/GlobalSettings/pages/eventsAndAlerts/Alerts/components/Step2';
import {
  parseQuery,
  scopeApplication,
  scopeDfq,
...
import AlertForm from 'in-settings/tabs/GlobalSettings/pages/eventsAndAlerts/Alerts/AlertForm';
import LoadingIndicator from 'in-components/LoadingIndicators/LoadingIndicator';
import { useSegmentTracking } from 'in-services/tracking/useSegmentTracking';
import { globalSettingsAlertingAlerts } from 'in-settings/navigation/paths';
import SettingsDetailPage from 'in-settings/components/SettingsDetailPage';
import { useNavigation } from 'in-stores/navigation/hooks/useNavigation';
import { SETTINGS_ALERT_SUBMIT } from 'in-services/tracking/eventNames';
...
export default function Alert(props) {
  ...
  return (
    <Form
      ...
      openEntities={() => goToPath(globalSettingsAlertingAlerts)}
      saveEntity={(alertEntity, form) => save(alertEntity, form, !entityId, trackCta)}
    />
  );
}
  ...
  return (
    <SettingsDetailPage>
      ...
      <SaveCancel
        ...
        loading={loading}
        isCreate={isCreate}
        listPath={globalSettingsAlertingAlerts}
      />
    </SettingsDetailPage>
  );
});
...
function save(alertEntity, form, isCreate, trackCta) {
  ...
  trackCta(SETTINGS_ALERT_SUBMIT, {
