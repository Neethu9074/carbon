...
import SplunkForm from 'in-settings/tabs/GlobalSettings/pages/integrations/logging/Splunk/SplunkForm';
import { globalSettingsIntegrationsLoggingSplunk } from 'in-settings/navigation/paths';
...
const Splunk = () => {
  ...
  const saveIntegrationForm = useCallback(() => {
    ...
    responseSubscriptionRef.current = result$.once(() => {
      ...
      setLoading(false);
      goToPath(globalSettingsIntegrationsLoggingSplunk);
    });
