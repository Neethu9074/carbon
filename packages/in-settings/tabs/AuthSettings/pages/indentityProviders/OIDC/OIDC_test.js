...
import { getConfigAsResultObservable } from 'in-settings/tabs/AuthSettings/api/ldap';
...
describe('in-settings/tabs/AuthSettings/pages/indentityProviders/OIDC/OIDC', () => {
  beforeEach(() => {
    jest.resetModules();
    mockEndpoints();
