...
export const teamSettingsAlertingEventFilterEdit = `${alerting}/alerts/:id`;
export const teamSettingsAlertingEventFilterNew = `${alerting}/alerts/new`;
export const teamSettingsAlertingEventFilters = `${alerting}/alerts`;
