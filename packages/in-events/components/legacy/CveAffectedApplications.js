...
import { DataTable as CarbonDataTable, TableSkeleton as CarbonTableSkeleton, Card, Link } from '@instana/components';
          ...
          <Fragment>
            {isLoading(stackResult) ? (
              ...
              <>
                ...
                <div className={locals.noDataMessage}>{t('in-events:affectedApplications.noAffectedApplications')}</div>
              </>
            )}
          </Fragment>
        </Card>
