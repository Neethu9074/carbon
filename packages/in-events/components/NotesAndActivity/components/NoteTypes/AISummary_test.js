...
describe('AISummary', () => {
  ...
  it('renders the text in a div with the correct class name', () => {
    ...
    expect(wrapper.find(`div.${locals.contentsHeader}`).at(2).text()).toEqual(
  ...
  it('renders the text in a div with the correct class name when relatedEvents, notes, and actions are present', () => {
    const wrapper = mount(
      <AISummary
        noteObj={{
    ...
    expect(wrapper.find(`div.${locals.summarySection}`).at(0).text()).toEqual(
      'Summary of notes:this is summary of notes'
    );
    expect(wrapper.find(`div.${locals.summarySection}`).at(1).text()).toEqual(
  ...
  it('renders the text in a div with the correct class name when recentEventsSummary, notes, and actions are present BUT EMPTY', () => {
    const wrapper = mount(
      <AISummary
        noteObj={{
          data: Immutable.fromJS({
