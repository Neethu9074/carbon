...
const SingleEntityOutput = ({
  ...
  if (backendResponse === null) {
    if (!backendLoading) {
      return error === null ? <p>{t('in-events:RCA.singleEntityLLM.runInvestigationInstructions')}</p> : <></>;
    } else {
      return <></>;
    }
  } else {
      ...
      <>
        <Stack gap="xxsmall">
                ...
                <Stack gap="small">
                  ...
                  <Stack gap="xxsmall">
                    <Typography variant="heading-compact-01">
                      {t('in-events:RCA.singleEntityLLM.factualityScoreTitle')} Factuality score
                    </Typography>
                    <Typography variant="body-compact-01">
                      <DangerousHtmlPresenter html={toHtml(backendResponse.fact_check.reasoning)} />
                    </Typography>
                  </Stack>
          ...
          <Typography variant="body-01">
            <DangerousHtmlPresenter html={toHtml(backendResponse.diagnosis.diagnosis)} />
          </Typography>
        </Stack>
        ...
        <Stack gap="xxsmall">
          ...
          <Typography variant="body-01">
            <DangerousHtmlPresenter html={toHtml(backendResponse.trace_error_log_summary)} />
          </Typography>
        </Stack>
        ...
        <Stack gap="xxsmall">
          ...
          <Typography variant="body-01">
            <DangerousHtmlPresenter html={toHtml(backendResponse.trace_log_summary)} />
          </Typography>
        </Stack>
        ...
        <Stack gap="xxsmall">
          ...
          <Typography variant="body-01">
            <DangerousHtmlPresenter html={toHtml(backendResponse.event_summary)} />
          </Typography>
        </Stack>
      </>
    );
