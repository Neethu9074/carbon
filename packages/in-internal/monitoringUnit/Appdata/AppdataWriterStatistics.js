      ...
      <DashboardSection title={t('in-internal:monitoringUnit.appdata.appdataWriterStatistics.clickHouseQueryLatency')}>
        <Chart
          ...
          y2={{
            ...
            labels: [
              t('in-internal:monitoringUnit.appdata.appdataWriterStatistics.mean'),
              t('in-internal:monitoringUnit.appdata.appdataWriterStatistics.50th'),
              t('in-internal:monitoringUnit.appdata.appdataWriterStatistics.99th')
            ],
            type: 'line'
          }}
        />
