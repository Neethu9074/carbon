...
import { ejbServiceExtractionPath, generalServiceExtractionView$ } from 'in-views/configurationView/navigation/paths';
import Link from 'in-components/Link';

export const ruleType = 'ejb';

export const pathname = ejbServiceExtractionPath;
...
export const helpTexts = defaults(
  {
    viewHelp: (
      <span>
        ...
        default service name using the bean name is used.
        <br />
        View our{' '}
