...
export const websitesAlertingJsErrorsOperatorChanged = (e: any) => track(WEBSITES_ALERTING_JS_ERRORS_OPERATOR_CHANGED, e);
export const websitesAlertingJsErrorsOpenErrorSelectView = (e: any) => track(WEBSITES_ALERTING_JS_ERRORS_OPEN_ERROR_SELECT_VIEW, e);
...
export const websitesAlertingThresholdOperatorChanged = (e: any) => track(WEBSITES_ALERTING_THRESHOLD_OPERATOR_CHANGED, e);
...
export const websitesAlertingThresholdTypeHelpIconHovered = (e: any) => track(WEBSITES_ALERTING_THRESHOLD_TYPE_HELP_ICON_HOVERED, e);
export const websitesAlertingThresholdDeviationFactorChanged = (e: any) => track(WEBSITES_ALERTING_THRESHOLD_DEVIATION_FACTOR_CHANGED, e);
...
export const websitesAlertingAdditionalPropsTitleChanged = (e: any) => track(WEBSITES_ALERTING_ADDITIONAL_PROPS_TITLE_CHANGE, e);
export const websitesAlertingAdditionalPropsAlertLevelChanged = (e: any) => track(WEBSITES_ALERTING_ADDITIONAL_PROPS_ALERT_LEVEL_CHANGED, e);
export const websitesAlertingAdditionalPropsTriggerChanged = (e: any) => track(WEBSITES_ALERTING_ADDITIONAL_PROPS_INCIDENT_TRIGGER_CHANGED, e);
export const websitesAlertingAdditionalPropsDescriptionChanged = (e: any) => track(WEBSITES_ALERTING_ADDITIONAL_PROPS_DESCRIPTION_CHANGED, e);
...
export const websitesAlertingEventDetailsGoToAnalyze = (e: any) => track(WEBSITES_ALERTING_EVENT_DETAILS_GO_TO_ANALYZE, e);
export const websitesAlertingEventDetailsViewEditConfig = (e: any) => track(WEBSITES_ALERTING_EVENT_DETAILS_VIEW_EDIT_CONFIG, e);
