...
import AlertConfigTearSheetStep4 from 'in-alerting/smart-alerts/logs/tearsheet/steps/AlertConfigTearSheetStep4';
...
export const stepConfigsForCarbonTearSheet = [
  ...
  },
  {
    ...
    validateIntermediately: [['threshold'], ['timeThreshold', 'timeWindow']],
