      ...
      <List
        ...
        loadEntities={() =>
          getTableData({
            ...
            ?.filter(
              (tableData: Result<PaginatedResult<MobileAppPaginatedBeaconGroupsItem>>) => tableData.data !== undefined
            )
            .map(
              (tableData: Result<PaginatedResult<MobileAppPaginatedBeaconGroupsItem>>) => tableData.data?.items ?? []
            )
        }
        pageSize={10}
