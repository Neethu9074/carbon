...
import SectionTearSheet from 'in-alerting/smart-alerts/components/tearSheet/Section/Section';
...
export default function ScopeEntity({ form, updateForm }: Readonly<ScopeEntityProps>) {
  ...
  if (!entityItems) {
    return (
      <SectionTearSheet
        titleHtmlFor={entityType}
        title={<AlertTypography variant="body-regular" color="color900" content={entityLabel} />}
      >
