...
import locals from 'in-alerting/smart-alerts/components/smart-alert-dialog/ConfigureAlertChannel.mless';
                ...
                <DialogFooter
                  ...
                  renderCustomSaveAction={() => (
                    <SaveButton
                      ...
                      kind="create"
                      form={form}
                      disabled={(!form.hierarchyValid && form.touched) || !numberOfItems}
                    >
                      {numberOfItems
