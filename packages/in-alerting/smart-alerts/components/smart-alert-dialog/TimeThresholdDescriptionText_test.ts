...
const {
  getDescription
} = require('in-alerting/smart-alerts/components/smart-alert-dialog/timeThresholdDescriptionText');

const GRANULARITY = 10000;

describe('in-alerting/smart-alerts/components/smart-alert-dialog/TimeThresholdDescriptionText', () => {
