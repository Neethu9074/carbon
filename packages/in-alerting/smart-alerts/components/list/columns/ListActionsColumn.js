...
export function ListActionsColumn({ config, isLoading, actionHandlers = {}, icon, useSmartAlertCreateUrl, urlParams }) {
  const {
    handleEdit,
    handleClone,
    handleToggleEnabled,
