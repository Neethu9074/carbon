...
export const ruleLogLevelOptions = Object.freeze([
  { value: 'ERROR', label: t('in-applications:ruleForm.ruleLogLevelOptions.error') },
  { value: 'WARN', label: t('in-applications:ruleForm.ruleLogLevelOptions.warning') },
  { value: 'ANY', label: t('in-applications:ruleForm.ruleLogLevelOptions.any') }
]);

export const ruleLogMessageOperatorOptions = Object.freeze([
  { value: operators.NOT_EMPTY, label: t('in-applications:ruleForm.ruleLogMessageOperationOptions.notEmpty') },
  { value: operators.EQUALS, label: t('in-applications:ruleForm.ruleLogMessageOperationOptions.equals') },
  { value: operators.CONTAINS, label: t('in-applications:ruleForm.ruleLogMessageOperationOptions.contains') },
  { value: operators.STARTS_WITH, label: t('in-applications:ruleForm.ruleLogMessageOperationOptions.startsWith') },
  { value: operators.ENDS_WITH, label: t('in-applications:ruleForm.ruleLogMessageOperationOptions.endsWith') }
]);
