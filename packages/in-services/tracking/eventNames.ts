...
export const CUSTOM_DASHBOARD_EIDT_TEAMS = 'custom.dashboard.edit.teams';
...
export const TURBONOMIC_OPTIMIZATION_BUTTON_CLICKED = 'whatsnew.TurbonomicOptimization';
...
export const OTEL_COLLECTOR_RESTART_CLICKED = 'otel.collector.restart.clicked';
export const OTEL_COLLECTOR_EDIT_CONFIGURATION_CLICKED = 'otel.collector.edit.configuration.clicked';
export const OTEL_COLLECTOR_UPDATE_CONFIGURATOIN_CLICKED = 'otel.collector.update.configuration.clicked';
...
export const EVENT_RCA_LLM_INVESTIGATION_START_CLICK = 'event.rca.llm.investigation.start.click';
export const EVENT_RCA_TOPOLOGY_VIEW_CLICK = 'event.rca.topology.view.click';
...
export const EVENT_AI_GENERATE_SUBMIT_OVERVIEW = 'event.ai.generate.submit.overview';
