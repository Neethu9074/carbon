...
export const builtInRulesPath = `${settingsPath}/builtInRules`;
export const builtInRulePath = `${settingsPath}/builtInRule`;
export const builtInRulePathTemplate = `${settingsPath}/builtInRule/:ruleId`;
