...
export default function SapJavaNetWeaverSystemSensorDashboard({ location }) {
  const props = {
    ...
    systemSnapShotPrefix: getMatrixParameter(location, sapJavaNetWeaverSystemSensorDashboard, systemSnapShotPrefix),
