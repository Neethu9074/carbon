...
import getSapWebDispatcherRelatedResourceLists from 'in-sap/subscriptions/getSapWebDispatcherRelatedResourceLists';
...
const pathSegment = '/sapwebdispatcher';
const matrixPrefix = 'sapwebdispatcher.';
...
function getTableData({ page = 0, pageSize = 20, orderBy = 'label', orderDirection = 'ASC', timeConfig, hostId }) {
  return getSapWebDispatcherRelatedResourceLists({
    pagination: {
      page,
      pageSize
    },
