...
export default function SapWebDispatcherDashboard({ location }) {
  const props = {
    hostId: getMatrixParameter(location, sapWebDispatcherDashboard, matrixHostId),
    systemPrefix: getMatrixParameter(location, sapWebDispatcherDashboard, systemPrefix),
    systemSnapShotPrefix: getMatrixParameter(location, sapWebDispatcherDashboard, systemSnapShotPrefix),
    viewPath: sapWebDispatcherDashboard,
      ...
      <TabView
        ...
        renderErrors={errors => (
          <CenterAlignmentColumn>
            <EntityVersionList
              plugin={plugins.sapWebDispatcher}
...
function Header(props) {
  return (
    <DashboardHeader
      {...props}
      title={t('in-sap:dashboards.sapWebDispatcher')}
      icon="lib_sap_sapWebDispatcher"
    ...
    <>
      {objectType && (
        <Tooltip themeStyle="light" content={`Type: ${objectType}`}>
          <WithIcon className={locals.icon} icon="lib_sap_sapWebDispatcher">
