        ...
        <div className={locals.availcontainer}>
          <div className={locals.leftcontent}>
            <table>
              <tr>
                <td>
                  <HealthDot color={theme.lib.colors.success} iconSize={SvgIconSizes.xxs} />
                </td>
                <td>{'Green'}</td>
              </tr>
              <tr>
                <td>
                  <HealthDot color={theme.lib.colors.yellow800} iconSize={SvgIconSizes.xxs} />
                </td>
                <td>{'Yellow'}</td>
              </tr>
              <tr>
                <td>
                  <HealthDot color={theme.lib.colors.failure} iconSize={SvgIconSizes.xxs} />
                </td>
                <td>{'Red'}</td>
              </tr>
            </table>
