...
export default connectTo(
  props => {
    return {
      data: getRawPayloadWithTimestamp(props.snapshotId, 'outboundTRfcInfo')
    };
  },

  function OutboundTransactionalRfcInfo({ data }) {
    ...
    return (
      <Table
        withoutPadding
        cardTitle={<TimeOfLastUpdateCardTitle title={t('in-sap:dashboards.outboundTransactionalRfcInfo')} />}
        cols={cols}
        rows={rows}
        initialSortColumn={0}
