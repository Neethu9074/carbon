...
export default function SapAbapInstanceSensorDashboard({ location }) {
  const props = {
    hostId: getMatrixParameter(location, sapAbapInstanceSensorDashboard, matrixHostId),
    systemPrefix: getMatrixParameter(location, sapAbapInstanceSensorDashboard, systemPrefix),
    systemSnapShotPrefix: getMatrixParameter(location, sapAbapInstanceSensorDashboard, systemSnapShotPrefix),
    viewPath: sapAbapInstanceSensorDashboard,
      ...
      <TabView
        ...
        renderErrors={errors => (
          <CenterAlignmentColumn>
            <EntityVersionList
              plugin={plugins.sapAbapInstanceSensor}
  ...
  return (
    <>
      ...
      <ContextGuide
        ...
        timeConfig={props.timeConfig}
        plugin={plugins.sapAbapInstanceSensor}
        tagFilters={[{ name: 'sapAbapInstanceSensor.snapshotId', value: props.hostId, operator: 'EQUALS' }]}
      />
    </>
  );
}
