...
import getSapHanaSystemRelatedResourceLists from 'in-sap/subscriptions/getSapHanaSystemRelatedResourceLists';
...
const pathSegment = '/saphanasystem';
const matrixPrefix = 'saphanasystems.';
...
function getTableData({ page = 0, pageSize = 20, orderBy = 'label', orderDirection = 'ASC', timeConfig, hostId }) {
  return getSapHanaSystemRelatedResourceLists({
    pagination: {
      page,
      pageSize
    },
