...
export const PROCESSING_TIME_COLOR = '#1A4FFF';
export const CALL_TIME_COLOR = '#f4d776';

export const TOTAL_TIME_LABEL = 'Total Time';
export const NETWORK_TIME_LABEL = 'Network';
export const PROCESSING_TIME_LABEL = 'Self';
export const CALL_TIME_LABEL = 'Waiting';
