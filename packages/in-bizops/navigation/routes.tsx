...
// @ts-expect-error module need to be translated to TS
import BizServicesList from 'promise-loader?global,bizops!in-bizops/lists/BizServicesList';
// @ts-expect-error module need to be translated to TS
...
import { servicesPath } from 'in-bizops/navigation/paths';
...
export default [
  ...
  <Route key="BizServicesList" exact path={servicesPath}>
    {renderAsyncRouteChildren(BizServicesList)}
  </Route>,
