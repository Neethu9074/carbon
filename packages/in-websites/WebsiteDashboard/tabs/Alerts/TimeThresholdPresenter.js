...
import { timeThresholdLabels } from 'in-websites/eum-alerting/advanced/TimeThresholdConfig/SelectThreshold';
...
export default function TimeThresholdPresenter({ config }) {
...
TimeThresholdPresenter.propTypes = {
