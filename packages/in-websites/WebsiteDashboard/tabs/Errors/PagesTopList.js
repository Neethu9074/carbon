...
const labels = [
  t('in-websites:websiteDashboard.tabs.errors.pageTopListLabelOccurrences'),
  t('in-websites:websiteDashboard.tabs.errors.pageTopListLabelAffectedUsers')
];
...
export default function PagesTopList({ websiteId, websiteLabel, timeConfig, tagFilters, urlMatrixParamConfig }) {
  return (
    <TopListWithUrlState
      title={t('in-websites:websiteDashboard.tabs.errors.pageTopListTitlePages')}
      metrics={metrics}
      labels={labels}
