...
export const patterRecognitionLocalisationStrings = {
  ...
  secondDescription_0: t('in-logging:dashboard.managementPage.patternRecognitionSet.secondDescription_0'),
  learnMore: t('in-logging:dashboard.managementPage.patternRecognitionSet.learnMore'),
