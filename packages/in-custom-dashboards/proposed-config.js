    ...
    },
    {
      ...
      items: [
          ...
          items: [
            {
              ...
              isExtenal: true,
              description:
                'Unit monitoring the EU SaaS installation, as well as the environment-wide components Groundskeeper, Butler and CockroachDB.'
            },
            {
              label: 'US',
        ...
        },
        {
          ...
          description:
            'These units are designed to be used mainly by the product organization of Instana to continue to evolve Instana itself.',
          items: [
            {
              label: 'Test',
              ...
              isExternal: true,
              description:
                'Auto-deployed on every commit to the develop branches. This is the unit on which most of the engineering work is integrated first. Notoriously unstable due to the deployment frequency. Choose a different unit if possible.'
            },
            {
              label: 'Release',
              ...
              isExternal: true,
              description:
                'Auto-deployed from the release-XYZ branch on every commit. Mainly used as part of the release preparation, but also for hot-fixes.'
            },
            {
              label: 'Load',
              ...
              isExternal: true,
              description:
                'Used to execute load tests and other experiments. Typically used as part of the release preparation.'
            }
          ]
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              isExternal: true,
              description:
                "A SaaS demo unit running within EU. This one is typically only used when 'current' is unavailable."
            },
            {
              label: 'demo',
              ...
              isExternal: true,
              description:
                "This unit will replace the 'current' and 'current2' unit once the demo setup is finished. The RobotShop is deployed here."
            }
          ]
        },
        {
          ...
          description:
            "Kubernetes based environments are currently being build. They aren't yet ready to replace our day-to-day environments, but will be in the near future. Once they are ready they will replace the similarly named non-Kubernetes based units.",
          items: [
            {
              label: 'Test',
            ...
            },
            {
              ...
              isExternal: true,
              description:
                'Manually deployed latest release-XYZ branch 1 week before the SaaS release. Sales / CS / SE / PM has access to this unit.'
            },
            {
              label: 'Release',
