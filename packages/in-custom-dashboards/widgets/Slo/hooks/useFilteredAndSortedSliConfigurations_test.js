...
jest.mock('in-custom-dashboards/widgets/Slo/hooks/useSliConfigurations', () => ({
  __esModule: true,
  default: jest.fn()
}));

describe('in-custom-dashboards/widgets/Slo/hooks/useFilteredAndSortedSliConfigurations', () => {
