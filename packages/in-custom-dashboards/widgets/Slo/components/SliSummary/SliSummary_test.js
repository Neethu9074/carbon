...
jest.mock('in-custom-dashboards/widgets/Slo/hooks/useSliFormatter', () => ({
  ...jest.requireActual('in-custom-dashboards/widgets/Slo/hooks/useSliFormatter'),
  useSliFormatter: jest.fn(),
  __esModule: true
}));

describe('in-custom-dashboards/widgets/Slo/components/SliSummary', () => {
