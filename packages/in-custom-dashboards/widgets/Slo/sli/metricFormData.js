...
export const sumAggregation = Object.freeze([{ value: 'SUM', label: t('in-custom-dashboards:widgets.slo.metricFormData.sum')}]);

export const meanAggregation = Object.freeze([{ value: 'MEAN', label: t('in-custom-dashboards:widgets.slo.metricFormData.mean') }]);
