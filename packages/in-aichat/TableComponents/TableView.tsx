...
import TableFilterPopover from 'in-aichat/TableComponents/TableFilterPopover';
import { TableState } from 'in-aichat/TableComponents/useTableState';
          ...
          <TableContainer>
            <TableToolbar>
              <TableToolbarSearch
                ...
                placeholder={t('in-aichat:aichat.searchTable')}
                id={`search-${tableId}`}
              />
              ...
              <CSVLink data={csvData.csvRows} headers={csvData.csvHeaders} filename="table-data.csv">
                <IconButton label={t('in-aichat:aichat.download')}>
                  <Download />
                </IconButton>
              </CSVLink>
            </TableToolbar>
