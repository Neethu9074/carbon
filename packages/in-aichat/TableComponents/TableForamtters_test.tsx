...
// Adding this because of the `user_defined` errors. Not sure how to fis in the moment
// const userDefined = fmt.output.generic[1].user_defined;
// @ts-nocheck

import { formatForTable, formatForBarChart, formatForEventsTable } from 'in-aichat/TableComponents/TableFormatters';
...
describe('formatForBarChart', () => {
  ...
  test('returns empty chart data when input tableData is empty', () => {
    const result = formatForBarChart(null);
