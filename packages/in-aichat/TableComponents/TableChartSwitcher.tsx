...
import { useTableState, TableRow, TableHeader } from 'in-aichat/TableComponents/useTableState';
import { formatForBarChart } from 'in-aichat/TableComponents/TableFormatters';
import TableView from 'in-aichat/TableComponents/TableView';
...
const TableChartSwitcher: React.FC<TableChartSwitcherProps> = ({ messageItem }) => {
  ...
  return (
    <div>
      ...
      >
        <Switch name="table" text={t('in-aichat:aichat.tableView')} />
        <Switch name="chart" text={t('in-aichat:aichat.chartView')} />
      </ContentSwitcher>
      {selectedIndex === 0 ? (
