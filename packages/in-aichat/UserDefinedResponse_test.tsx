...
jest.mock('in-aichat/CustomResponse/PromptLibraryResponse', () => ({
  __esModule: true,
  default: () => <div data-testid="prompt-library-response">Prompt Library Response</div>
}));

jest.mock('in-aichat/TableComponents/TableChartSwitcher', () => ({
  __esModule: true,
  default: () => <div data-testid="table-chart-switcher">Table Chart Switcher</div>
}));

jest.mock('in-aichat/CustomResponse/ThumbsFeedback', () => ({
  __esModule: true,
  default: () => <div data-testid="thumbs-feedback">Thumbs Feedback</div>
}));

jest.mock('in-aichat/TableComponents/EventsTable', () => ({
  __esModule: true,
  default: () => <div data-testid="events-table">Events Table</div>
}));

jest.mock('in-aichat/CustomResponse/TypeTextResponse', () => ({
  __esModule: true,
