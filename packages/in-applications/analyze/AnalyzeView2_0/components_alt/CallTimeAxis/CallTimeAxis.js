...
import CallStartLabel from 'in-applications/analyze/AnalyzeView2_0/components_alt/CallTimeAxis/CallStartLabel';
    ...
    <div className={locals.timeAxis} ref={ref}>
      ...
      {width && (
        <HorizontalAxis
          ...
          fixedTickPositions={tickPositions}
          // CallStartLabel takes care about the first tick label
          renderTickLabels={tickPositions.length > 1}
        />
      )}
    </div>
  );
