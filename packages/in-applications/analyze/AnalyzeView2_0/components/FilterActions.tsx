...
import { Group, TagFilterExpressionElementUnion } from '@instana/types';
...
export const FilterActions = ({ backendQueryModel, formModel, group, setUrlState }: Props): JSX.Element => {
  return (
    <Stack orientation="horizontal">
      <SaveFilterPopover backendQueryModel={backendQueryModel} formModel={formModel} group={group} />
      &nbsp;
      <SavedFilters setUrlState={setUrlState} />
    </Stack>
  );
};
