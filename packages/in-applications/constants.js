export const boundaryScopes = {
  ...
  info: {
    INBOUND: {
      ...
      dashboard:
        'Inbound calls: The dashboard is displaying information based only on the calls that are performed by the consumers of this application.',
      overrideDefault:
    ...
    ALL: {
      ...
      dashboard:
        'All calls: The dashboard is displaying information based on all calls that are performed within this application, by both consumers as well as internally.',
