export const boundaryScopes = {
  ...
  info: {
    INBOUND: {
      ...
      overrideDefault: 'The default for this application is Inbound Calls only. You can change this in Configuration.'
    },
    ALL: {
      text: 'All Calls',
      ...
      overrideDefault: 'The default for this application is All Calls. You can change this in Configuration.'
    }
  }
};
