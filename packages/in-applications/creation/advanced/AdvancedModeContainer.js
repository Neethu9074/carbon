  ...
  return (
    <div>
      ...
      <FormGroup>
        ...
        <DescriptionText className={locals.advancedDescription}>
      ...
      <Spacer type="dark" />
      <h1 className={locals.heading}>3. Downstream services.</h1>
      <ApplicationScopeSelector
        form={form}
        updateForm={updateForm}
        description={
          <DescriptionText className={locals.advancedDescription}>
            By checking the box to the left, you are including in the application all services that transitively fall
            downstream of those matched by the tags specified above, instead of only the immediate
            <Pill color={getColor('DATABASE')} kind="light">
              DATABASE
            </Pill>
            and
      ...
      />
      <Spacer type="dark" />
      <h1 className={locals.heading}>4. Application Scope</h1>
