...
module.exports = {
  ...
  demo3: {
    user: 'stan@instana.com',
    pw: '4711',
    uiBackendUrl: 'https://demo3-instana.instana.io/api',
    groundskeeperUrl: 'https://demo3-instana.instana.io'
  },
  lab: {
    user: 'stan@instana.com',
    pw: '4711',
    uiBackendUrl: 'https://lab-instana.instana.io/api',
    groundskeeperUrl: 'https://lab-instana.instana.io'
  },
  monitoring: {
    user: 'stan@instana.com',
    pw: '4711',
    uiBackendUrl: 'https://monitoring-instana.instana.io/api',
    groundskeeperUrl: 'https://monitoring-instana.instana.io'
  },
  demo: {
    user: 'stan@instana.com',
    pw: '4711',
