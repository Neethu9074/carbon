...
export default class HighlightingComponentForCylinder extends BaseHighlightingComponent {
  ...
  setupHighlightBorderLines() {
    ...
    this.lineContentProvider.setLines([
      ...
      // top
      fromX + lineScaleX * 0.476, 0.5, fromZ + lineScaleZ * -0.155,
      fromX + lineScaleX * 0.405, 0.5, fromZ + lineScaleZ * -0.294,

      fromX + lineScaleX * 0.405, 0.5, fromZ + lineScaleZ * -0.294,
      fromX + lineScaleX * 0.294, 0.5, fromZ + lineScaleZ * -0.405,

      fromX + lineScaleX * 0.294, 0.5, fromZ + lineScaleZ * -0.405,
      fromX + lineScaleX * 0.155, 0.5, fromZ + lineScaleZ * -0.476,

      fromX + lineScaleX * 0.155, 0.5, fromZ + lineScaleZ * -0.476,
      fromX + lineScaleX * 0.000, 0.5, fromZ + lineScaleZ * -0.500,
      ...
      fromX + lineScaleX * 0.476, 0.5, fromZ + lineScaleZ * 0.155,
      fromX + lineScaleX * 0.500, 0.5, fromZ + lineScaleZ * 0.000,
