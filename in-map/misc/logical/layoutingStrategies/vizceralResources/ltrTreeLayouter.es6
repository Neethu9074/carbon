...
(function Layouter() {
  const LTRTreeLayouter = (function LTRTreeLayouter() {
    const ltrTreeLayouter = () => {};
    ...
    ltrTreeLayouter.prototype.layout = (nodes, edges, dimensions, entryNode) => {
      ...
      Ranker.forceSecondaryRankPromotions(graph, entryNode);
