 ...
 */
export function get_last_exception(report) {
...
export function header(left, right, extra) {
  if (!left) {
    return left;
  }
 ...
 */
export function pad_hex(input, char, count) {
 ...
 * @param count the length of the String.
 */
export function pad_left(input, char, count) {
 ...
 * @param count the length of the String.
 */
export function pad_right(input, char, count) {
