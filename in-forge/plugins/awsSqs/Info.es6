...
export default function Info({ snapshot }) {
  ...
  return (
    <DescriptionList>
      ...
      <DescriptionItem title="Message Retention Period">
        {data.get('msg_retention_period')}
      </DescriptionItem>
      <DescriptionItem title="Max Message Size">
        {data.get('max_msg_size')}
      </DescriptionItem>
      <DescriptionItem title="Visibilty Timeout">
        {data.get('visibilty_timeout')}
      </DescriptionItem>
      <DescriptionItem title="Last Modified Timeout">
        {data.get('last_modified_timeout')}
      </DescriptionItem>
    </DescriptionList>
  );
}
