...
import {
  ...
  collapseNode,
  expandNode
} from 'in-forge/plugins/rubyRuntimePlatform/Dashboard/CpuProfiler/stores/expandedNodes';
import {
  selectedNode$,
  setSelectedNode
} from 'in-forge/plugins/rubyRuntimePlatform/Dashboard/CpuProfiler/stores/selectedNode';
import PercentageIndicator from 'in-forge/plugins/rubyRuntimePlatform/Dashboard/CpuProfiler/PercentageIndicator';
...
const block = 'in-ruby-cpu-profiling-table';
