...
import {isProfiling$, lastProfilingResult$} from 'in-forge/plugins/rubyRuntimePlatform/Dashboard/CpuProfiler/store';
import ResultTable from 'in-forge/plugins/rubyRuntimePlatform/Dashboard/CpuProfiler/ResultTable';
