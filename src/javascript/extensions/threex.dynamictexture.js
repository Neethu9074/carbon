 ...
 */
exports.DynamicTexture = function DynamicTexture(width, height) {
 ...
 * clear the canvas
 *
 * @param  {String*} fillStyle the fillStyle to clear with,
 * if not provided, fallback on .clearRect
 * @return {THREEx.DynamicTexture} the object itself, for chained texture
 */
exports.DynamicTexture.prototype.clear = function(fillStyle) {
 ...
 * @param  {Number|undefined}	x	if provided,
 * it is the x where to draw, if not, the text is centered
 ...
 * @return {THREEx.DynamicTexture}	the object itself, for chained texture
 */
exports.DynamicTexture.prototype.drawText = function(text, x, y,
	fillStyle,
	contextFont) {
	// set font if needed
...
exports.DynamicTexture.prototype.drawTextCooked = function(text, options) {
 ...
 */
exports.DynamicTexture.prototype.drawImage = function(
	/* same params as context2d.drawImage */
) {
	// call the drawImage
