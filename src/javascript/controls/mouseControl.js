...
exports.MouseControl.prototype.onMouseUp = function() {
	...
	if (millisSinceMouseDown < 500 && //intervall to click
		this.hittenObject !== undefined) {
		//clicked on object!
		this.appRef.clickedOnObject(this.hittenObject);
		this.targetPositionObj.position.x = this.hittenObject.position.x;
		this.targetPositionObj.position.z = this.hittenObject.position.z;
	}
};
