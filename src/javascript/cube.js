...
exports.Cube.prototype.update = function(app) {
	...
	if (this.tweenDirection !== tweenDirection) {
		...
		if(tweenDirection === DIRECTION.IN){
			this.setTransparency(app, {v: 1}, {v: 0.25});
		} else {
			this.setTransparency(app, {v: 0.25}, {v: 1});
		}
	}
};


exports.Cube.prototype.setTransparency = function(app, from, to, delay) {
	//save the material!
