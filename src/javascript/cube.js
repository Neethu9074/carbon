...
exports.Cube = function Cube(x, y, scaleFactor) {
  ...
  var lodCubes = createLODCubes(width, height, depth, this.name);
  ...
  lodCubes.position.set(xMiddle, yMiddle, zMiddle);
  collisionCube.position.set(xMiddle, yMiddle, zMiddle);
  boundingCube.position.set(xMiddle, yMiddle, zMiddle);

  var lodLabels = createLODLabels(width, height, depth, this.name);
  lodLabels.position.add(new THREE.Vector3(xMiddle, yMiddle, zMiddle));
...
function createLODLabels(width, height, depth, name) {
...
function createLODCubes(width, height, depth, name) {
	var detailedCube = createCube(width, height, depth, name, true);
	var cube = createCube(width, height, depth, name, false	);
