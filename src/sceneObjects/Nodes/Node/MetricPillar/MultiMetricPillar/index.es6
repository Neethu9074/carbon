...
export default class MultiMetricPillar extends SceneObject {
  ...
  onInactiveEnter() {
    ...
    this.removeFromMultiMetricFactory();
  }

  onInactiveLeave() {
    this.addToMultiMetricFactory();
