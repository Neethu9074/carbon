...
UI_BACKEND_PORT_8080_TCP_ADDR=$(curl -s http://localhost:8500/v1/catalog/service/$REGION-$INSTANA_ENVIRONMENT-$INSTANA_TENANT-$INSTANA_TENANT_UNIT-ui-backend | jq '.[0].Address')
